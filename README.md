...
```bash
BASE=https://cdn.jsdelivr.net/gh/chenzai666/proxy-setup@master; curl -fsSL "$BASE/setup_proxy.sh" -o /tmp/sp.sh && PROXY_SETUP_REMOTE_BASE_URL="$BASE" bash /tmp/sp.sh; rm -f /tmp/sp.sh
```
