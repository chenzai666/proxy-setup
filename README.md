...
```powershell
$w=New-Object Net.WebClient;$w.Encoding=[Text.Encoding]::UTF8;iex($w.DownloadString('https://cdn.jsdelivr.net/gh/chenzai666/proxy-setup@85e4417/setup_proxy.ps1'))
```

> `@85e4417` 是包含 Claude / OpenAI 出口 IP 检测和 macOS Bash/v2rayN 自动检测修复的固定版本；固定 commit 不会自动更新。
